...
class Gui(gui_base.GuiBase):
    def gui(self):
        ...
        self.widget["GroupName"] = gui_base.YSLineEdit(label="★ Group Name", placeholder_text="Spline")

        self.widget["Frame2"] = gui_base.YSFrame(label="Skeleton")
        self.widget["SplineJointCount"] = gui_base.YSDoubleSpinBox(label="★ Spline Joint Count", range=[4, 99], decimals=0, step=1)
        ...
        self.widget["CtrlCount"] = gui_base.YSDoubleSpinBox(label="Ctrl Count", range=[4, 20], decimals=0, step=1)
    ...
    def call(self):
        guide = self.klass(
            ...
            self.widget["SplineJointCount"].get(),
